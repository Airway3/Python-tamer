...
Klass.func1 = func # это обычный объект функции на уровне модуля
...
# но иногда...
instance.func2 = func # это обычный объект функции на уровне модуля
print(instance.__dict__)
instance.func2() # мы присвоили атрибуту инстанса обьычную функцию, в которую не передаётся селф
print('/' * 30)
...
instance.field # если определён проперти, то он вернётся а не атрибуты.
